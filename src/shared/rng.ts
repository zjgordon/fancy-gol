/**
 * Mulberry32 — a small, fast, deterministic PRNG. Lives in `shared/` so `engine/` and `ui/`
 * share one implementation (ADR-009 pure-logic lane, P2-A-1). All simulation randomness still
 * flows through an instance of this class (README §3.8: determinism is load-bearing).
 */
